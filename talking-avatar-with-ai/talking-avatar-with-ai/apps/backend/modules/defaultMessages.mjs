...
async function sendDefaultMessages({ userMessage }) {
  ...
  if (!userMessage) {
    messages = [
      ...
      {
        text: "I'm Harsh, your personal AI assistant. I'm here to help you with anything you need.",
  ...
  if (!elevenLabsApiKey || !openAIApiKey) {
    messages = [
      ...
      {
        text: "You don't want to ruin Harsh with a crazy ChatGPT and ElevenLabs bill, right?",
